...
import { InteractiveIphone } from "./interactive-iphone"
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <div className="text-center mb-12">
          ...
          >
            <h1 className="font-serif text-[3.5rem] sm:text-[4.5rem] md:text-[5.5rem] lg:text-[6.5rem] xl:text-[7.5rem] 2xl:text-[8.5rem] font-normal leading-tight mb-6 w-full px-4 max-w-6xl mx-auto text-balance">
              <AnimatedText text="Where sound becomes legacy" delay={0.3} />
            </h1>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center justify-center gap-8">
          <div className="relative">
            <div
              className={`relative will-change-transform transition-all duration-[1500ms] ease-out delay-500 ${
          ...
          <div
            className={`transition-all duration-1000 delay-[1000ms] ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-[400px]"}`}
          >
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a
                href="https://open.spotify.com/artist/music.lab47"
                target="_blank"
