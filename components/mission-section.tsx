...
import { Mic2, Disc3, Globe } from "lucide-react"
...
const Mission = [
  {
    ...
    description: "World-class studios, vocal coaching, and creative direction to shape every artist's sound.",
  },
  {
    icon: Disc3,
    title: "Production & mastering",
    description: "Grammy-winning producers and engineers crafting records that cut through any platform.",
  },
  {
    icon: Globe,
    title: "Global distribution",
    description: "Your music delivered to every major streaming service and store worldwide, day one.",
  },
]
...
export function MissionSection() {
  ...
  return (
    <section id="Mission" className="py-32 px-6 pb-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="order-1 lg:order-2">
              ...
              <h2 className="font-sans md:text-4xl lg:text-5xl font-medium text-white text-balance mb-8 text-5xl">
                Amplifying the next generation of sound
              </h2>
              <div className="space-y-6 text-white/90 leading-relaxed">
                <p>
                  At Music Lab, we believe great artists deserve more than a contract. We pair raw talent with the
                  resources, mentorship, and platform to turn a vision into a movement.
                </p>
                <p>
                  From the first demo to a sold-out tour, we stand behind every artist with transparent deals, creative
                  freedom, and a team obsessed with the craft of music.
                </p>
              </div>
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            A full-service label built to develop, record, and launch artists on the world stage.
          </p>
        </div>
